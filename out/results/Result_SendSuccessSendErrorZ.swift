...
extension Bindings {
	...
	public class Result_SendSuccessSendErrorZ: NativeTypeWrapper {
		...
		internal func clone() -> Result_SendSuccessSendErrorZ {
			// native call variable prep


			// native method call
			let nativeCallResult =
				withUnsafePointer(to: self.cType!) { (origPointer: UnsafePointer<LDKCResult_SendSuccessSendErrorZ>) in
					CResult_SendSuccessSendErrorZ_clone(origPointer)
				}
		...
		internal func danglingClone() -> Result_SendSuccessSendErrorZ {
